...
class jsTPS{
    constructor(){
        //creates a new array for transactions to be contained
        this.transactions = [];
     ...
     * 
     * @param {jTPS_Transaction} transaction The custom transaction to be added to
     ...
     * 
     * @return {Number} The number of transactions currently in the transaction stack.
     */
    getLength() {
     ...
     * 
     * @return {Number} The number of transactions in the stack that can be redone.
     */
    getRedoLength() {
        return this.getLength() - this.mostRecentTransaction - 1;
    }
